      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="index.php?acao=<?php echo $item1?>" class="nav-link <?php $item1ativo  ?>">
            ...
            <li class="nav-item">
              <a href="index.php?acao=<?php echo $item2?>" class="nav-link <?php $item2ativo  ?>">
            ...
            <li class="nav-item">
              <a href="index.php?acao=<?php echo $item3?>" class="nav-link <?php $item3ativo  ?>">
